    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-4">
        <Button
          ...
          size="icon"
          onClick={() =>
            setLocation(isEditing ? `/employees/${id}` : "/employees")
          }
        >
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Textarea
                    id="address"
                    placeholder="Unit 8 90-92 Pohlman St, SOUTHPORT QLD 4215"
                    rows={2}
                ...
                <div className="space-y-2">
                  <Label htmlFor="tfn">TFN (Tax File Number)</Label>
                  <Input
                    id="tfn"
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="designation"
                    placeholder="e.g. Subcontractor, Painter"
