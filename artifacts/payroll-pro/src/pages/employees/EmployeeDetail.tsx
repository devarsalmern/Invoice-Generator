    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-muted-foreground mt-1 flex items-center gap-2">
                ...
                {employee.designation || "Employee"} at{" "}
                {company?.name || `Company #${employee.companyId}`}
              </p>
            </div>
          </div>
        </div>
        <div className="flex items-center gap-2">
          <Button
            variant="outline"
            onClick={() => setLocation(`/employees/${id}/edit`)}
          >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div className="space-y-1">
                  ...
                  <p className="font-medium">
                    {employee.joiningDate
                      ? format(new Date(employee.joiningDate), "d MMMM yyyy")
                      : "Not specified"}
                  </p>
                </div>
                <div className="space-y-1">
                ...
                {emp.tfn && (
                  <div className="space-y-1">
                    ...
                    <p className="font-mono">{emp.tfn}</p>
                  </div>
                )}
              </div>
            </CardContent>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm">
                  {format(new Date(employee.createdAt), "d MMM yyyy h:mm a")}
                </p>
              </div>
            </CardContent>
          </Card>
