...
export default function PayslipForm() {
  ...
  const form = useForm<PayslipFormValues>({
    ...
    defaultValues: {
      ...
      items: [{ date: today, description: "Daily subcontract painting services", quantity: "1", unitPrice: "0", taxRate: "10" }],
    },
  });
  ...
  useEffect(() => {
    if (watchEmployeeId && employees) {
      ...
      items.forEach((_, idx) => {
        form.setValue(`items.${idx}.unitPrice`, rate);
      });
    }
            ...
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => append({ date: today, description: "Daily subcontract painting services", quantity: "1", unitPrice: defaultHourlyRate, taxRate: "10" })}
                >
                ...
                return (
                  <div key={field.id} className="grid grid-cols-12 gap-2 items-start">
                    <div className="col-span-2">
                      ...
                      {form.formState.errors.items?.[idx]?.date && <p className="text-xs text-destructive mt-1">{form.formState.errors.items?.[idx]?.date?.message}</p>}
                    </div>
